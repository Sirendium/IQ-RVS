...
namespace iSpyApplication
{
    public partial class Settings : Form
    {
        ...
        private void SettingsLoad(object sender, EventArgs e)
        {
            ...
            txtAppendLinkText.Text = "https://www.bysec.sk/";
        ...
        private void RenderResources()
        {
            ...
            label14.Text = LocRm.GetString("BYSEC ServerName");
            label16.Text = LocRm.GetString("BYSEC OpacitymayNotW");
            ...
            chkUseiSpy.Text = LocRm.GetString("Use BYSEC Servers");
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            txtAlertSubject.Text = "[EVENT]: [SERVER] [OBJECTNAME]";
            txtAlertBody.Text = txtSMSBody.Text = "[EVENT] at [DATE] [TIME]: [SERVER] [OBJECTNAME] [RECORDED] [PLUGIN]";            
            txtAppendLinkText.Text = "<br/>bysec.sk/";
        }
