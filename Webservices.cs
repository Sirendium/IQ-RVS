...
namespace iSpyApplication
{
    public partial class Webservices : Form
    {
        ...
        private void RenderResources()
        {
            ...
            label5.Text = "If you are connecting multiple instances of BYSEC, you must select a different port combination for each instance. ";
            label6.Text = "To access your cameras, microphones and captured content over the web or with mobile devices and to use BYSEC alerting services  you will need an BYSEC Connect account.";
            label7.Text = LocRm.GetString("usingIpv6BYSECmightBeAbleT");
